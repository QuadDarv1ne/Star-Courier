...
def get_ability(branch: str, ability_id: str) -> dict:
...
def get_available_abilities(character: dict, chapter: int) -> list:
...
def check_ability_requirements(ability: dict, character: dict, game_state: dict) -> bool:
